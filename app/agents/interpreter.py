...
from app.email_client import search_for_replies, get_message_details, mark_as_read
...
def create_llm_with_key(api_key: str):
    ...
    llm = ChatGroq(model="llama-3.1-70b-versatile", temperature=0, groq_api_key=api_key)
